...
class ImageConvertPage(ft.Column):
    ...
    def __init__(self, page: ft.Page) -> None:
        ...
        self._run_btn = ft.FilledButton("开始转换", icon=ft.Icons.TRANSFORM, on_click=self._start, disabled=True)
        ...
        return ft.Container(
            content=ft.Row(
                controls=[
                    ...
                    ft.Container(
                        content=ft.Icon(ft.Icons.TRANSFORM, color="#2563eb", size=20),
                        width=40, height=40, bgcolor="#eff6ff", border_radius=10, alignment=ft.Alignment(0, 0),
                    ),
                    ft.Text("图片格式转换", size=20, weight=ft.FontWeight.W_600, color="#162f50", font_family="Manrope"),
                ],
